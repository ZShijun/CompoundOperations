...
namespace CompoundOperations.Grammar {
     ...
     * parser.</remarks>
     */
    internal abstract class CompoundAnalyzer : Analyzer {
        ...
        public override void Enter(Node node) {
            switch (node.Id) {
            case (int) CompoundConstants.ADD:
                EnterAdd((Token) node);
                break;
            case (int) CompoundConstants.SUB:
                EnterSub((Token) node);
                break;
            case (int) CompoundConstants.MUL:
                EnterMul((Token) node);
                break;
            case (int) CompoundConstants.DIV:
                EnterDiv((Token) node);
                break;
            case (int) CompoundConstants.POWER:
                EnterPower((Token) node);
                break;
            case (int) CompoundConstants.MOD:
                EnterMod((Token) node);
                break;
            case (int) CompoundConstants.LEFT_PAREN:
                EnterLeftParen((Token) node);
                break;
            case (int) CompoundConstants.RIGHT_PAREN:
                EnterRightParen((Token) node);
                break;
            case (int) CompoundConstants.LEFT_BRACE:
                EnterLeftBrace((Token) node);
                break;
            case (int) CompoundConstants.RIGHT_BRACE:
                EnterRightBrace((Token) node);
                break;
            case (int) CompoundConstants.EQ:
                EnterEq((Token) node);
                break;
            case (int) CompoundConstants.NE:
                EnterNe((Token) node);
                break;
            case (int) CompoundConstants.LT:
                EnterLt((Token) node);
                break;
            case (int) CompoundConstants.GT:
                EnterGt((Token) node);
                break;
            case (int) CompoundConstants.LE:
                EnterLe((Token) node);
                break;
            case (int) CompoundConstants.GE:
                EnterGe((Token) node);
                break;
            case (int) CompoundConstants.AND:
                EnterAnd((Token) node);
                break;
            case (int) CompoundConstants.OR:
                EnterOr((Token) node);
                break;
            case (int) CompoundConstants.XOR:
                EnterXor((Token) node);
                break;
            case (int) CompoundConstants.NOT:
                EnterNot((Token) node);
                break;
            case (int) CompoundConstants.IN:
                EnterIn((Token) node);
                break;
            case (int) CompoundConstants.DOT:
                EnterDot((Token) node);
                break;
            ...
            case (int) CompoundConstants.HEX:
                EnterHex((Token) node);
                break;
            case (int) CompoundConstants.REAL:
                EnterReal((Token) node);
                break;
            case (int) CompoundConstants.STRING:
                EnterString((Token) node);
                break;
            case (int) CompoundConstants.CHAR:
                EnterChar((Token) node);
                break;
            case (int) CompoundConstants.TRUE:
                EnterTrue((Token) node);
                break;
            case (int) CompoundConstants.FALSE:
                EnterFalse((Token) node);
                break;
            case (int) CompoundConstants.NULL:
                EnterNull((Token) node);
                break;
            case (int) CompoundConstants.DATETIME:
                EnterDatetime((Token) node);
                break;
            case (int) CompoundConstants.IF:
                EnterIf((Token) node);
                break;
            case (int) CompoundConstants.IFS:
                EnterIfs((Token) node);
                break;
            ...
            case (int) CompoundConstants.LOGICAL_EXPRESSION:
                ...
                break;
            case (int) CompoundConstants.BOOLEAN_EXPRESSION:
                EnterBooleanExpression((Production) node);
                break;
            case (int) CompoundConstants.COMPARISON_EXPRESSION:
                EnterComparisonExpression((Production) node);
                break;
            case (int) CompoundConstants.ADDITIVE_EXPRESSION:
                EnterAdditiveExpression((Production) node);
                break;
            case (int) CompoundConstants.MULTIPLICATIVE_EXPRESSION:
                EnterMultiplicativeExpression((Production) node);
                break;
            case (int) CompoundConstants.NEGATIVE_EXPRESSION:
                EnterNegativeExpression((Production) node);
                break;
            ...
            case (int) CompoundConstants.MULTIPLICATIVE_OPERATOR:
                EnterMultiplicativeOperator((Production) node);
                break;
            case (int) CompoundConstants.COMPARISON_OPERATOR:
                EnterComparisonOperator((Production) node);
                break;
            case (int) CompoundConstants.LOGICAL_OPERATOR:
                EnterLogicalOperator((Production) node);
                break;
            case (int) CompoundConstants.FACTOR:
                EnterFactor((Production) node);
                break;
            case (int) CompoundConstants.ATOM:
        ...
        public override Node Exit(Node node) {
            ...
            case (int) CompoundConstants.COMPARISON_EXPRESSION:
                return ExitComparisonExpression((Production) node);
            case (int) CompoundConstants.ADDITIVE_EXPRESSION:
            ...
            case (int) CompoundConstants.MULTIPLICATIVE_OPERATOR:
                return ExitMultiplicativeOperator((Production) node);
            case (int) CompoundConstants.COMPARISON_OPERATOR:
        ...
        public override void Child(Production node, Node child) {
            ...
            case (int) CompoundConstants.BOOLEAN_EXPRESSION:
                ...
                break;
            case (int) CompoundConstants.COMPARISON_EXPRESSION:
                ChildComparisonExpression(node, child);
                break;
            case (int) CompoundConstants.ADDITIVE_EXPRESSION:
            ...
            case (int) CompoundConstants.MULTIPLICATIVE_EXPRESSION:
                ...
                break;
            case (int) CompoundConstants.NEGATIVE_EXPRESSION:
                ChildNegativeExpression(node, child);
                break;
            case (int) CompoundConstants.POWER_EXPRESSION:
            ...
            case (int) CompoundConstants.ADDITIVE_OPERATOR:
                ...
                break;
            case (int) CompoundConstants.MULTIPLICATIVE_OPERATOR:
                ChildMultiplicativeOperator(node, child);
                break;
            case (int) CompoundConstants.COMPARISON_OPERATOR:
         ...
         * discovered errors</exception>
         */
        public virtual void EnterLe(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitLe(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterGe(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitGe(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterHex(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitHex(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterIfs(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitIfs(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterComparisonExpression(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitComparisonExpression(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildComparisonExpression(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterNegativeExpression(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitNegativeExpression(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildNegativeExpression(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterAdditiveOperator(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitAdditiveOperator(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildAdditiveOperator(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterMultiplicativeOperator(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitMultiplicativeOperator(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildMultiplicativeOperator(Production node, Node child) {
            node.AddChild(child);
        }
